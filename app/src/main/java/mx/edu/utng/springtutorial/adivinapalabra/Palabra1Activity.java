 ...
 */
public class Palabra1Activity extends Activity {

    LinearLayout ly_contenedor;
    private final String palabra = "SPRING";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.palabra1_latyout);
        ly_contenedor = (LinearLayout)findViewById(R.id.lny_pal1);
            ...
            public void onClick(View v) {
                if(notBlank()){
                    if(getAllText().equals(palabra)){
                        ...
                        startActivity(new Intent(getApplicationContext(), Palabra2Activity.class));
                    }else {
