 ...
 */
public class Palabra5Activity extends Activity {

    LinearLayout ly_contenedor;
    private final String palabra = "for";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.palabra5_layout);
        ly_contenedor = (LinearLayout)findViewById(R.id.lny_pal5);
            ...
            public void onClick(View v) {
                if(notBlank()){
                    if(getAllText().equals(palabra)){
                        ...
                        startActivity(new Intent(getApplicationContext(), Palabra6Activity.class));
                    }else {
