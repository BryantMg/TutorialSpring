 ...
 */
public class Palabra4Activity extends Activity {

    LinearLayout ly_contenedor;
    private final String palabra = "String";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.palabra4_layout);
        ly_contenedor = (LinearLayout)findViewById(R.id.lny_pal4);
            ...
            public void onClick(View v) {
                if(notBlank()){
                    if(getAllText().equals(palabra)){
                        ...
                        startActivity(new Intent(getApplicationContext(), Palabra5Activity.class));
                    }else {
