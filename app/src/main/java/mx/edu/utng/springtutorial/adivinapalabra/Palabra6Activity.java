 ...
 */
public class Palabra6Activity extends Activity {

    LinearLayout ly_contenedor;
    private final String palabra = "show";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.palabra6_layout);
        ly_contenedor = (LinearLayout)findViewById(R.id.lny_pal6);
            ...
            public void onClick(View v) {
                if(notBlank()){
                    if(getAllText().equals(palabra)){
                        ...
                        startActivity(new Intent(getApplicationContext(), FinActivity.class));
                    }else {
